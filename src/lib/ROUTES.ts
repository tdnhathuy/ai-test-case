...
const SERVERS = {
  ...
  "PATCH /api/profile/transaction/[id]": (params: { id: (string | number) }) => {
    return `/api/profile/transaction/${params['id']}`
  },
